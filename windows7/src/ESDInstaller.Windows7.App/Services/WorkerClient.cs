...
public sealed class WorkerClient
{
    ...
    {
        var localRoot = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "ESDInstallerWindows7");
        ...
        var pipeName = "ESDInstallerWindows7-" + plan.PlanId.ToString("N");
                   ...
                   PipeOptions.Asynchronous))
        {
            ...
            var workerPath = Path.Combine(workerDirectory, "ESDInstaller.Windows7.Worker.exe");
