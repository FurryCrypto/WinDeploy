...
internal static class Program
{
    ...
    {
        var root = FindRepositoryRoot(); var strings = Path.Combine(root, "windows7", "src", "ESDInstaller.Windows7.App", "Strings");
        ...
        var selector = File.ReadAllText(Path.Combine(root, "windows7", "src", "ESDInstaller.Windows7.App", "SettingsWindow.xaml.cs"));
        var settings = File.ReadAllText(Path.Combine(root, "windows7", "src", "ESDInstaller.Windows7.App", "Services", "SettingsService.cs"));
