...
using WinDeploy.Core.Installation;
using WinDeploy.Core.Models;
using WinDeploy.Core.Services;

namespace WinDeploy.Worker;
    ...
    private static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            var plan = JsonSerializer.Deserialize<InstallationPlan>(json, JsonOptions())
                       ?? throw new WinDeployException("ValidationPlanUnreadable", "The installation plan was empty.");
            ...
            IInstallationEngine engine = plan.Engine switch
            {
                ...
                _ => throw new WinDeployException("LegacyEngineUnavailable", plan.Engine.ToString())
            };
