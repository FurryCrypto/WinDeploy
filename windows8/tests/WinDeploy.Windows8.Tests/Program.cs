...
internal static class Program
{
    ...
    {
        var root = FindRepositoryRoot(); var strings = Path.Combine(root, "windows8", "src", "WinDeploy.Windows8.App", "Strings");
        ...
        var selector = File.ReadAllText(Path.Combine(root, "windows8", "src", "WinDeploy.Windows8.App", "SettingsWindow.xaml.cs"));
        var settings = File.ReadAllText(Path.Combine(root, "windows8", "src", "WinDeploy.Windows8.App", "Services", "SettingsService.cs"));
        ...
        var destinationPage = File.ReadAllText(Path.Combine(root, "windows8", "src", "WinDeploy.Windows8.App", "Views", "DestinationPage.xaml"));
