...
namespace WinDeploy.Windows8.Views;
...
public partial class ProgressPage : Page
{
    ...
    public async System.Threading.Tasks.Task ExecuteAsync(InstallationPlan plan)
    {
        ...
        try
        {
            ...
            ResultBanner.Visibility = Visibility.Visible; SuccessPanel.Visibility = Visibility.Visible;
    ...
    private void RestartLater_Click(object sender, RoutedEventArgs e) => MessageBox.Show(Window.GetWindow(this), App.Services.Localizer.Get("RestartLaterMessage"), "WinDeploy", MessageBoxButton.OK, MessageBoxImage.Information);
