...
public sealed class WorkerClient
{
    ...
    {
        var localRoot = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "WinDeployWindows8");
        ...
        var pipeName = "WinDeployWindows8-" + plan.PlanId.ToString("N");
                   ...
                   PipeOptions.Asynchronous))
        {
            ...
            var workerPath = Path.Combine(workerDirectory, "WinDeploy.Windows8.Worker.exe");
